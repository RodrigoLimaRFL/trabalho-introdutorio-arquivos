all: lista.o cabecalho.o funcoes_fornecidas.o gerencia-arquivo.o registro.o escreveBin.o interpreta-bin.o indice.o criarIndice.o main.o
	gcc registro.o lista.o cabecalho.o gerencia-arquivo.o escreveBin.o interpreta-bin.o funcoes_fornecidas.o indice.o criarIndice.o main.o -o gerencia-arquivo -std=c99 -Wall
